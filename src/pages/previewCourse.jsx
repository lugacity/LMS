...
import { ProfessionalList, professionalItems, industriesItems } from '../Components/ProfessionalList';
import SocialMediaLinks, { socialMediaData } from "../Components/SocialMediaLink";
            ...
            <section>
                    ...
                    <div className="lg:py-4 lg:px-14 pt-10 px-4">
                        <div className={styles.checkoutCoursesFlex}>
                            ...
                            <div className={styles.checkoutCourses2}>
                                <input type="text" className={styles.inputField} placeholder="Search courses..." />
                            </div>
                        </div>
                ...
                <div className='lg:py-4 lg:px-14 pt-10 px-4'>
                    <div className={styles.overviewFlex}>
                        <div className={`${styles.overviewCourses1} text-[#667185] text-justify`}>
                            ...
                            <p className="pt-2">
                                ...
                                comprehensive and intensive course designed for aspiring project consultants 
                                who aim to excel in the dynamic field of project management. Scheduled to 
                                commence in May 2024, this training programme equips participants with the essential 
                                skills, knowledge, and hands-on experience necessary to thrive as project consultants 
                        ...
                        <div className={`${styles.overviewCourses1} text-[#667185]`}>
                            ...
                            <p className="pt-2">
                                <FontAwesomeIcon className='mr-2' icon={faCheckCircle} />
                                 Mastery of project management software (e.g., MS Project, Jira, Asana)
                            </p>
                    ...
                    <div className={`${styles.overviewFlex} py-8`}>
                        <div className={`${styles.overviewCourses1} text-[#667185] text-justify`}>
                            ...
                            <p className="pt-2">
                                <FontAwesomeIcon className='mr-2' icon={faCheckCircle} />
                                Industry Recognition: Gain credibility and recognition as a certified project consultant.
                            </p>

                            <p className="pt-2">
                                <FontAwesomeIcon className='mr-2' icon={faCheckCircle} />
                                Networking Opportunities: Connect with peers, mentors, and industry experts.
                            </p>

                            <p className="pt-2">
                                <FontAwesomeIcon className='mr-2' icon={faCheckCircle} />
                                 Lifetime Access: Continue to access course materials and updates even after the programme ends.
                            </p>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex items-start mt-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p>Comprehensive coverage of project management principles, methodologies, and tools</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start mt-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p>Learn from industry-leading professionals and experienced consultants</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start mt-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p>Real-world projects and case studies to apply learned concepts</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start mt-2">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p>Earn a recognized certification upon successful completion</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className={styles.checkout_courses}>
					<div className="lg:py-0 lg:px-14 pt-2 px-8">
						...
						<div className={`${styles.career_content} py-8 text-[#667185] lg:w-1/2 w-full`}>
							<p> Discover our most popular courses, carefully curated to enhance 
                        ...
                        <div className={styles.certificate_courses}>
                            <div className="lg:py-4 lg:px-14 pt-10 px-8">
                                ...
                                <div className={styles.certificateCourses1}>
                                    ...
                                    <p className="text-[#667185] py-2 ">Professional Training + Life Project Experience (Online)</p>
                                </div>
                        ...
                        <div className={styles.certified_pro}>
                            ...
                            <ImageOverlay>
                                <div className={`${styles.certified_content} lg:py-8 lg:px-14 pt-10 px-8`}>
