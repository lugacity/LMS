  ...
  return (
    <>
      ...
      <Container className="grid gap-16 md:grid-cols-2 lg:gap-28">
        <div>
          <h2 className="font-poppins text-2xl font-light leading-normal text-[#3A4C6C] md:text-[2.5rem]">
            Data Management and Strategy Services
          </h2>
          <p className="my-6 font-poppins text-[#667185] md:text-2xl">
            Unlock the Power of Your Data with Avenue Impact Consulting
          </p>
          <p className="text-justify font-poppins text-base text-[#667185] md:text-xl">
        ...
        <div className="flex items-end gap-4 align-baseline md:gap-0 lg:gap-4">
          <p className="font-poppins font-light text-[#667185] md:text-2xl">
      ...
      <Container className="text-center">
        <h2 className="text-2xl font-light text-[#3A4C6C] md:text-[2.5rem]">
          Data Analytics Services
        </h2>
        <p className="mb-8 mt-4 font-poppins text-[#667185] md:text-2xl">
          Transforming Raw Data into Actionable Insights
        </p>
        <p className="text-justify font-poppins text-[#667185] md:text-center md:text-xl">
      ...
      <Container className="text-center">
        ...
        <div className="m-auto my-10 flex max-w-2xl items-center gap-4">
          <p className="font-poppins text-2xl font-light text-[#667185]">
