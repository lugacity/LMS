    ...
    <>
      <ImageHero imageSrc={img} className={"items-end lg:items-start"}>
        <div className="lg:mt-24">
          <div>
            ...
            <ul className="ml-auto mt-0 max-w-[45.375rem] list-disc space-y-3 *:ml-6 *:font-poppins *:text-base *:font-light *:text-[#f4f5f7] *:md:text-xl lg:mt-28 *:lg:text-xl">
              <li>
      ...
      <Container className="grid gap-16 md:grid-cols-2 lg:gap-28">
        <div>
          ...
          <p className="text-justify font-poppins text-[16px] text-[#667185] lg:text-[18px]">
        ...
        <div className="flex items-end gap-4 align-baseline md:gap-0 lg:gap-4">
          <p className="font-poppins text-[16px] text-[#667185] lg:text-[18px]">
      ...
      <Container className="text-left lg:text-center">
        <h2 className="text-[24px] font-[400] text-[#3A4C6C] lg:text-[40px]">
          Data Analytics Services
        </h2>
        <p className="mb-8 mt-4 font-poppins text-[16px] font-[400] text-[#667185] lg:text-[24px]">
          Transforming Raw Data into Actionable Insights
        </p>
        <p className="text-justify font-poppins text-[16px] font-[400] text-[#667185] md:text-center lg:text-[20px]">
      ...
      <Container className="text-center">
        <h2 className="text-[24px] font-[300] text-[#3A4C6C] md:text-[2.5rem] lg:text-[35px]">
