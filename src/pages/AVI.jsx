					...
					<div className="lg:py-4 lg:px-14 pt-10 px-8">
						...
						<div className={`${styles.team_skills} py-24`}>
							...
							<div className={styles.team_skills_img}>
								<img className="w-full sm:w-full md:w-full lg:w-3/4" src={teamDiscussion} alt="teamDiscussion" />
							</div>
							...
							<div className={styles.team_skills_content}>
								...
								<p className="text-justify"> Gain unlimited access to over 25,000 top courses anytime, anywhere. 
									Discover our international course collection available in 14 languages 
									and earn premier certifications in technology and business.</p>
							</div>
