...
export const EmptyGetCertificate = () => {
  return (
    <div>
      <div className="grid w-full grid-cols-12 gap-6 rounded-lg">
        ...
        <div className="col-span-5 mb-4 h-[480.95px] rounded-lg border-2 border-gray-100 bg-white px-8 py-4 md:mb-0">
