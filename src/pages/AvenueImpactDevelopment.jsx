    ...
    <>
      <ImageHero imageSrc={img}>
        <div>
          ...
          <div className="mb-8 mt-8 block h-px w-full bg-white lg:hidden" />
          <p className="ml-auto mt-0 max-w-[45.375rem] font-poppins text-base font-light text-white md:text-xl lg:mt-20 lg:text-2xl">
