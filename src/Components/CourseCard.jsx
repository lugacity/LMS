...
const CourseCard = ({
  ...
  return (
    <div className="bg-[rgb(252,252,252)]">
      ...
      <div className={`rounded-b-lg px-[7px] py-[6px] text-[14px] text-[#667185] md:px-3 md:py-2 lg:px-4 lg:py-[14px] lg:text-[16px]`}>
        <p className="">{title}</p>
        <div className={`${styles.courseNumber} mb-2 mt-[6px] flex items-center justify-start gap-2 lg:mb-5 lg:mt-[14px]`}>
