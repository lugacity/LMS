...
const AvenueImpactItem = ({ number, title, content, isHighlighted }) => {
    return (
        <div className={isHighlighted ? styles.expert_transform2 : styles.expert_transform}>
            <p>{number}</p>
            <p>{title}</p>
            <p>{content}</p>
        </div>
    ...
    const impacts = [
        {
            number: "01",
            title: "Analysis",
            content: "The first step in our services is to work closely with you to understand your business needs and goals.",
            isHighlighted: false
        },
        {
            number: "01",
        ...
        },
        {
            number: "01",
            title: "Hello World",
            content: "The first step in our services is to work closely with you to understand",
            isHighlighted: true
        }
    ];
