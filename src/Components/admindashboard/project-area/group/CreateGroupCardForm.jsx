...
import { useCreateGroupCard } from "@/hooks/project-area-groups/use-create-group-card";
import { useEditCard } from "@/hooks/project-area/use-edit-project-card";
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm } from "react-hook-form";
import { useParams, useSearchParams } from "react-router-dom";
import { sessionSchema } from "../CreateFormModal";
import { useEditGroupCard } from "@/hooks/project-area-groups/use-edit-group-course-card";

function CreateGroupCardForm({ setModal, edit, setEdit }) {
  const { create, isPending } = useCreateGroupCard();
  const { editCard, isPending: isEditing } = useEditGroupCard();
...
export default CreateGroupCardForm;
