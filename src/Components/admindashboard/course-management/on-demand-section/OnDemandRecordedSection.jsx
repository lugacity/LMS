...
import RecordedSectionPopover from "../recoded-session/RecordedSectionPopover";
import RecordedVideoSectionPopover from "../recoded-session/RecordedVideoSectionPopover";
            ...
            return (
              <AccordionItem key={course.id} value={course.id}>
                <div className="grid grid-cols-[8fr_1fr] items-center">
                  ...
                  <SectionPopover section={course.section}>
