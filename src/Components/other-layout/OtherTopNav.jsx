    ...
    <nav className="flex gap-[97px] px-3 py-[25px] md:px-5">
      <div className="flex w-full items-center justify-between gap-1 md:gap-6 lg:w-max lg:justify-normal">
        <button type="button" className="flex items-center gap-1">
          <span className="flex items-center justify-center rounded-sm border-[#E4E7EC] text-base md:text-[10px] text-black md:h-6 md:w-6 md:border">
            <FaLongArrowAltLeft />
          </span>
      ...
      <div className="hidden lg:block">
        <ul className="flex items-center gap-3 *:text-nowrap">
          <li className="after:contents-[''] relative flex cursor-pointer gap-2 capitalize text-tertiary-color-700 transition-colors duration-300 ease-linear after:absolute after:-bottom-2 after:left-0 after:block after:h-px after:w-0 after:bg-[#CC1747] hover:text-primary-color-600 hover:after:w-full 2xl:gap-[13px]">
