function LiveSession() {
  return (
    <div>
      ...
      <section className="mt-7 px-10 md:mt-10 lg:mt-16">
        ...
        <button className="mt-5 rounded-md bg-tertiary-color-700 px-4 py-2 text-[#C7D7F4] hover:bg-[#C7D7F4] hover:text-tertiary-color-700 lg:mt-8">
